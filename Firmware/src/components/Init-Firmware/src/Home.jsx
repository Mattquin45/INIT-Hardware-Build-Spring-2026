...
export default function Home() {
  ...
  const [showDorasMap, setShowDorasMap] = useState(false); 

  // If Dora's Map is active, render it full screen
  if (showDorasMap) {
    return <DorasMap onBack={() => setShowDorasMap(false)} />;
  }
      ...
      <div className="flex gap-10 items-end">
        ...
        <button
          ...
          className="
            ...
            shadow-xl float flex flex-col items-center justify-center
            hover:scale-110 hover:shadow-red-300 transition duration-300
          "
        >
          <img src={map} className="w-32 h-32 mb-3" />
          <span className="text-xl font-semibold text-gray-700">Dora's map</span>
        </button>
